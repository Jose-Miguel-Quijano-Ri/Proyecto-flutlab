...
class CloralexWidget extends StatefulWidget {
  const CloralexWidget({Key key}) : super(key: key);

  @override
  _CloralexWidgetState createState() => _CloralexWidgetState();
}

class _CloralexWidgetState extends State<CloralexWidget> {
