...
class CocaWidget extends StatefulWidget {
  const CocaWidget({Key key}) : super(key: key);

  @override
  _CocaWidgetState createState() => _CocaWidgetState();
}

class _CocaWidgetState extends State<CocaWidget> {
