...
class FantaWidget extends StatefulWidget {
  const FantaWidget({Key key}) : super(key: key);

  @override
  _FantaWidgetState createState() => _FantaWidgetState();
}

class _FantaWidgetState extends State<FantaWidget> {
