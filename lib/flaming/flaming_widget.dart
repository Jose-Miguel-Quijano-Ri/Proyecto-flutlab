...
class FlamingWidget extends StatefulWidget {
  const FlamingWidget({Key key}) : super(key: key);

  @override
  _FlamingWidgetState createState() => _FlamingWidgetState();
}

class _FlamingWidgetState extends State<FlamingWidget> {
