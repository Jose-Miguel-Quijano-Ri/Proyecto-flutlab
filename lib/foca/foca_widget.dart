...
class FocaWidget extends StatefulWidget {
  const FocaWidget({Key key}) : super(key: key);

  @override
  _FocaWidgetState createState() => _FocaWidgetState();
}

class _FocaWidgetState extends State<FocaWidget> {
