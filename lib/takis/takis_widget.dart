...
class TakisWidget extends StatefulWidget {
  const TakisWidget({Key key}) : super(key: key);

  @override
  _TakisWidgetState createState() => _TakisWidgetState();
}

class _TakisWidgetState extends State<TakisWidget> {
