...
class XtraCareWidget extends StatefulWidget {
  const XtraCareWidget({Key key}) : super(key: key);

  @override
  _XtraCareWidgetState createState() => _XtraCareWidgetState();
}

class _XtraCareWidgetState extends State<XtraCareWidget> {
